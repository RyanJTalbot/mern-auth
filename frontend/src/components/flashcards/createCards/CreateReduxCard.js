...
export default class CreateReduxCard extends Component {
	constructor(props) {
		super(props);
	...
	componentDidMount() {
		axios
			.get('http://localhost:8000/reduxs/')
			.then((response) => {
	...
	onSubmit(e) {
		...
		// Axios POST /reduxs/add
		axios
			.post('http://localhost:8000/reduxs/add', redux)

...
export default class CreateJavaScriptCard extends Component {
	constructor(props) {
		super(props);
	...
	componentDidMount() {
		axios
			.get('http://localhost:8000/javascripts/')
			.then((response) => {
	...
	onSubmit(e) {
		...
		// Axios POST /javascripts/add
		axios
			.post('http://localhost:8000/javascripts/add', javascript)
	...
	render() {
		return (
			<Container>
				<h3>Create New JavaScript Card</h3>
